...
namespace MyPaint
{
    ...
    class Toolbox
    {
        ...
        public Toolbox(IForm form, Point p)
        {
            ...
            pen_button.Location = new Point(p.X + 320, p.Y + 10);
            ...
            eraser_button.Location = new Point(p.X + 320, p.Y + 60);
            ...
            for (int i = 0; i < width_img_paths.Length; i++)
            {
                ...
                width_buttons[i].Location = new Point(p.X + 360, p.Y + 10 + i * 22);
            ...
            for (int i = 0; i < cols.Length; i++)
            {
                ...
                color_buttons[i].Location = new Point(p.X + 500 + i * 40, p.Y + 35);
            ...
            more_colors_button.Location = new Point(p.X + 910, p.Y + 15);
            ...
            checked_color_label.Location = new Point(p.X + 445, p.Y + 65);
            ...
            more_colors_label.Location = new Point(p.X + 910, p.Y + 55);
        ...
        private void Paint(IForm form, IPaintEventProps e)
        {
            ...
            e.Graphics.FillRectangle(brush, p.X + 440, p.Y + 10, 50, 80);
            e.Graphics.DrawRectangle(pen, p.X + 440, p.Y + 10, 50, 80);
            e.Graphics.FillRectangle(brush, p.X + 905, p.Y + 10, 60, 80);
            e.Graphics.DrawRectangle(pen, p.X + 905, p.Y + 10, 60, 80);
            brush.Color = state.Color;
            e.Graphics.FillRectangle(brush, p.X + 445, p.Y + 15, 40, 40);
            e.Graphics.DrawRectangle(pen, p.X + 445, p.Y + 15, 40, 40);
        }
        ...
        {
            if (sender.Index == width_buttons[0].Index) state.Width = 1;
            if (sender.Index == width_buttons[1].Index) state.Width = 2;
            if (sender.Index == width_buttons[2].Index) state.Width = 4;
            if (sender.Index == width_buttons[3].Index) state.Width = 8;
        }
        ...
        private void ColorButtonClicked(IButton sender) { state.Color = sender.BackColor; form.Refresh(); }
